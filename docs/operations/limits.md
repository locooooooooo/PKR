...
| --- | --- | --- |
| Configured Provider or Verification timeout | 100 ms to 600,000 ms | config rejected outside range; elapsed child is force-terminated and marked `TimedOut` |
...
| Command arguments | 128 arguments; 64 KiB per argument | Provider config or Verification plan rejected |
